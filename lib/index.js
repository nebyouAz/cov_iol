...
function setupApp () {
  ...
  app.all('*', async (req, res) => {
    ...
    let importedFile
    try {
      importedFile = await fs.readFileSync(__dirname + imported_File.json, 'utf8')
      console.log("Imported File readable file ")
    } catch (err) {
      importedFile = err.message
      console.log("root directory":__dirname)
      console.log("File not readable ": importedFile)
      return
    }
  })
  return app
